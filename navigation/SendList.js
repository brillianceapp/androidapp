         ...
         <ScrollView>
           <View flex={2} style={{flexDirection:"row",paddingHorizontal:30,marginBottom:10}}>
             ...
             <View flex={1} style={{alignItems:"flex-end"}}>
               <Text style={{color:"black",fontSize:16}}>0.001</Text>
               <Text style={{color:"black",fontSize:16}}>10000.00$</Text>
             </View>
           </View>
           ...
           <View flex={2} style={{flexDirection:"row",paddingHorizontal:30,marginBottom:10}}>
             ...
             <View flex={1} style={{alignItems:"flex-end"}}>
               <Text style={{color:"black",fontSize:16}}>0.87</Text>
               <Text style={{color:"black",fontSize:16}}>2458.00$</Text>
             </View>
           </View>
           ...
           <View flex={2} style={{flexDirection:"row",paddingHorizontal:30,marginBottom:10}}>
             ...
             <View flex={1} style={{alignItems:"flex-end"}}>
               <Text style={{color:"black",fontSize:16}}>0.078</Text>
               <Text style={{color:"black",fontSize:16}}>98.00$</Text>
             </View>
           </View>
           <View flex={2} style={{flexDirection:"row",paddingHorizontal:30,marginBottom:10}}>
             <View flex={1}>
